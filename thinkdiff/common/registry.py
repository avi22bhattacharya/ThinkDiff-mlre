...
class Registry:
    ...
    def register_builder(cls, name):
        ...
        Usage:
            ...
            from thinkdiff.datasets.base_dataset_builder import BaseDatasetBuilder
        """
    ...
    def register_model(cls, name):
        ...
        def wrap(model_cls):
            from thinkdiff.models import BaseModel
    ...
    def register_processor(cls, name):
        ...
        def wrap(processor_cls):
            from thinkdiff.processors import BaseProcessor
