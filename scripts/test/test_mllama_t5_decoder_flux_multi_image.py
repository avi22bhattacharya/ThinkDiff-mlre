...
def main():
    ...
    for img_i in range(1):
        ...
        for image_i, image in enumerate(images):
            image.save(f"{output_dir}/{image_name}_output_embed_edit_4_flux_{image_i}_{ckpt_id}.png", format="PNG", compress_level=1)
            print(f"Saved image to {output_dir}/{image_name}_output_embed_edit_4_flux_{image_i}_{ckpt_id}.png")
